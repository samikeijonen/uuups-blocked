...
add_action(
	...
	function() {
		// Main scripts.
		wp_enqueue_script( 'uuups-blocked-app', asset( 'js/app.js' ), null, null, true );

		// Main styles.
		wp_enqueue_style( 'uuups-blocked-style', asset( 'css/style.css' ), null, null );
...
add_action(
	...
	function() {
		// Editor styles.
		wp_enqueue_style( 'uuups-blocked-editor', asset( 'css/editor.css' ), null, null );

		// Editor scripts.
		wp_enqueue_script(
			'uuups-blocked-editor-scripts',
...
function asset( $path ) {
	...
	if ( null === $manifest ) {
		...
		$manifest = file_exists( $file ) ? json_decode( file_get_contents( $file ), true ) : null;
	}
