...
add_action(
	...
	function() {
		...
		load_theme_textdomain( 'uuups-blocked-blocked', get_parent_theme_file_path( 'resources/lang' ) );
		...
		add_theme_support(
			...
			[
				[
					'name'  => esc_html__( 'Main', 'uuups-blocked' ),
					'slug'  => 'main',
					'color' => 'hsl(245, 80%, 43%)',
				],
				[
					'name'  => esc_html__( 'Dark', 'uuups-blocked' ),
					'slug'  => 'dark',
					'color' => 'hsl(245, 82%, 7%)',
				],
				[
					'name'  => esc_html__( 'White', 'uuups-blocked' ),
					'slug'  => 'white',
					'color' => 'hsl(0, 0%, 100%)',
				],
				[
					'name'  => esc_html__( 'Light', 'uuups-blocked' ),
					'slug'  => 'light',
					'color' => 'hsl(245, 20%, 97%)',
				],
				[
					'name'  => esc_html__( 'Grey', 'uuups-blocked' ),
					'slug'  => 'grey',
		...
		add_theme_support(
			...
			[
				[
					'name' => esc_html__( 'Small', 'uuups-blocked' ),
					'size' => 14,
					'slug' => 'small',
				],
				[
					'name' => esc_html__( 'Medium', 'uuups-blocked' ),
					'size' => 20,
					'slug' => 'medium',
				],
				[
					'name' => esc_html__( 'Large', 'uuups-blocked' ),
					'size' => 24,
					'slug' => 'large',
				],
				[
					'name' => esc_html__( 'Larger', 'uuups-blocked' ),
					'size' => 40,
					'slug' => 'larger',
				],
			]
...
add_action(
	...
	function() {
		...
		register_nav_menus(
			[
				'primary' => esc_html_x( 'Primary', 'nav menu location', 'uuups-blocked' ),
				'social'  => esc_html_x( 'Social Links', 'nav menu location', 'uuups-blocked' ),
			]
		);
...
add_action(
	...
	function() {
		...
		register_sidebar(
			[
				'id'   => 'primary',
				'name' => esc_html_x( 'Primary', 'sidebar', 'uuups-blocked' ),
			] + $args
		);
	},
	5
