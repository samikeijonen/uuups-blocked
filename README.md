[![Build Status](https://travis-ci.org/samikeijonen/uuupsblocked.svg?branch=dev)](https://travis-ci.org/samikeijonen/uuupsblocked)
...
- `UuupsBlocked\get_svg()` function returns inline SVG icon markup by default.
- For example `UuupsBlocked\get_svg( [ 'icon' => 'folder-open' ]`.
