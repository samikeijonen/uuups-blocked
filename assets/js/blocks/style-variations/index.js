...
wp.domReady( () => {
	...
	wp.blocks.registerBlockStyle( 'core/button', {
		name: 'default',
		label: __( 'Default', 'uuups-blocked' ),
		isDefault: true,
	} );
	...
	wp.blocks.registerBlockStyle( 'core/button', {
		name: 'rounded',
		label: __( 'Rounded', 'uuups-blocked' ),
	} );

	wp.blocks.registerBlockStyle( 'core/button', {
		name: 'underlined',
		label: __( 'Underlined', 'uuups-blocked' ),
	} );

	wp.blocks.registerBlockStyle( 'core/button', {
		name: 'outline-rounded',
		label: __( 'Outline rounded', 'uuups-blocked' ),
	} );

	wp.blocks.registerBlockStyle( 'core/paragraph', {
		name: 'ingress',
		label: __( 'Ingress', 'uuups-blocked' ),
	} );

	wp.blocks.registerBlockStyle( 'core/paragraph', {
		name: 'highlight',
		label: __( 'Highlight', 'uuups-blocked' ),
	} );
